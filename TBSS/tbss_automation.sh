...
subjs="pt865 pt866 pt867 pt868 pt869"
...
fslview_deprecated $FSLDIR/data/standard/MNI152_T1_1mm mean_FA -l Red-Yellow -b .2,.6 &
fslview_deprecated all_FA mean_FA_skeleton -l Green -b .2,.6
...
#cd ${main_dir}/tbss/stats
#tbss_sym FA
#fslview_deprecated $FSLDIR/data/standard/MNI152_T1_1mm mean_FA_skeleton -l Green \
